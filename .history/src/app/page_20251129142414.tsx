    ...
    <div className="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mb-4 leading-relaxed">
          Designed and delivered a comprehensive dual-purpose cloud platform for the hospitality sector. 
          The system acts as a digital bridge, integrating a consumer-facing loyalty app with a robust 
          business management hub for subscribing members.
        </p>
        
        {/* Feature Bullets */}
        <ul className="space-y-3 mb-6 text-slate-700 dark:text-slate-300">
          <li className="flex items-start gap-3">
            <div className="mt-1 bg-orange-100 dark:bg-orange-900/30 p-1 rounded-full">
          ...
          <li className="flex items-start gap-3">
            ...
            <span className="text-sm"><strong>Community Hub:</strong> A B2B web platform featuring a peer-to-peer marketplace and real-time messaging.</span>
          </li>
        </ul>
      </div>
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
          Engineered a high-availability <strong>Hybrid Architecture</strong> on Google Cloud Platform. 
          The system leverages <strong>Cloud Run</strong> for dynamic Next.js rendering and a serverless 
          <strong>Firebase</strong> backend for atomic transactions and real-time synchronization. 
        </p>

        <div className="flex flex-wrap gap-2">
          {['Next.js 15', 'React 19', 'Flutter', 'TypeScript', 'GCP Cloud Run', 'NoSQL', 'Docker'].map((tech) => (
            <Badge key={tech} variant="secondary" className="bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-200 border-0">
              {tech}
            </Badge>
          ))}
        </div>
