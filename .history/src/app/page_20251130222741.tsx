        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Karaoke Name",
                desc: "Real-time karaoke gig management platform with queue management, song requests, and location-based discovery for hosts and singers.",
                tags: ["Next.js", "Firebase", "PWA", "Real-time"],
                link: "/projects/karaoke-name",
                image: "/images/projects/karaoke-name/hero.jpg"
              },
              {
                title: "CAFE:CONNECT",
                ...
                image: "/images/projects/cafe-connect/hero.jpg"
              },
              {
                ...
                link: "/projects/est85",
                image: "/images/projects/est85/hero.jpg"
              }
            ].map((project, index) => (
              <motion.div
                key={index}
              ...
              >
                <Card className="overflow-hidden h-full border-0 shadow-lg group cursor-pointer">
                  <div className="h-48 bg-slate-200 dark:bg-slate-700 relative overflow-hidden">
                    ...
                    {/* Placeholder for hero image - will be replaced when images are provided */}
                    <div className="absolute inset-0 flex items-center justify-center text-slate-400 dark:text-slate-500 font-bold text-2xl opacity-50 group-hover:scale-110 transition-transform duration-500">
                      {project.title.substring(0, 2)}
                    </div>
                    {/* Hero image will be added here when provided */}
                    {/* <Image 
                      src={project.image}
                      alt={project.title}
                      fill
