              ...
              <div className="space-y-3">
                ...
                <ul className="space-y-2 text-xs text-muted-foreground">
                  ...
                  <li className="flex items-start gap-2">
                    <div className="w-1 h-1 rounded-full bg-green-500 mt-1.5 shrink-0" />
                    <span>
                      <strong>Data Integrity:</strong> Atomic Transactions ensuring marketplace reliability.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1 h-1 rounded-full bg-green-500 mt-1.5 shrink-0" />
                    <span>
                      <strong>Async Logic:</strong> "Fan-out" write patterns in Cloud Functions for notification delivery.
                    </span>
                  </li>
                </ul>
              </div>
