                ...
                <div className="mb-8">
                  ...
                  <div className="flex gap-4">
                    ...
                    <Button asChild variant="outline">
                      <a href="https://apps.apple.com/ph/app/cafe-connect/id6742357756" target="_blank" rel="noopener noreferrer">
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            <Button asChild size="xl" className="bg-white text-blue-600 hover:bg-blue-50 text-lg px-8 py-6 rounded-full shadow-2xl">
