  ...
  <div className="flex flex-col lg:flex-row">
    <div className="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
      <div className="mb-8">
        ...
        {/* Added Role Title for Authority */}
        <h3 className="text-xl font-semibold text-slate-800 dark:text-slate-100 mb-2">
          Lead Developer & Architect
        </h3>

        <p className="text-muted-foreground mb-6 leading-relaxed">
          Architected a comprehensive B2B/B2C hospitality ecosystem on <strong>Google Cloud Platform</strong>. 
          Engineered a hybrid system integrating a <strong>Next.js 15</strong> web platform (Cloud Run) with native <strong>Flutter</strong> clients. 
          The architecture features a serverless backend with <strong>Firebase</strong> for real-time data synchronization, 
          atomic transactions for the marketplace, and automated CI/CD pipelines via GitHub Actions.
        </p>
        
        {/* Updated Badges to reflect the Tech Stack in CV */}
        <div className="flex flex-wrap gap-2 mb-8">
          {[
            ...
            <Badge key={tech} variant="outline" className="px-3 py-1 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors cursor-default">
              {tech}
            </Badge>
          ))}
        </div>
        ...
        <div className="flex flex-wrap gap-4 items-center">
          ...
          {/* App Store Links */}
          <a href="https://apps.apple.com/ph/app/cafe-connect/id6742357756" target="_blank" rel="noopener noreferrer" className="flex h-10 transition-opacity hover:opacity-80">
            <img
          ...
          <a href="https://play.google.com/store/apps/details?id=com.independentcafeownersnetwork.iconrewards" target="_blank" rel="noopener noreferrer" className="flex h-10 transition-opacity hover:opacity-80">
            <img
...
{/* Skills Overview Section - Updated to match CV */}
      ...
      {[
        {
          ...
          icon: "📱",
          // Emphasize Cross-platform capability
          skills: "Flutter, Dart, iOS, Android, Native Integration",
        ...
        },
        {
          ...
          skills: "Next.js 15, React 19, TypeScript, Tailwind, Three.js",
        ...
        },
        {
          ...
          icon: "⚙️",
          // Focus on Node/Firebase/NoSQL
          skills: "Node.js, Firebase, Cloud Functions, NoSQL",
        ...
        },
        {
          title: "Cloud & DevOps",
          icon: "☁️",
          // Swapped Azure for GCP and added Docker
          skills: "GCP (Cloud Run), Docker, CI/CD, GitHub Actions",
        ...
        >
          <Card className="h-full hover:shadow-lg transition-shadow duration-300 border-none bg-slate-50/50 dark:bg-slate-800/50">
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground mb-4 text-sm leading-relaxed">{skill.skills}</p>
