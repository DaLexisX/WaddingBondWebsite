        ...
        <div className="lg:w-1/2 p-8 lg:p-10 flex flex-col">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Column A: Hybrid Architecture (Unchanged) */}
              <div className="space-y-3">
                ...
                <ul className="space-y-2 text-xs text-muted-foreground">
                  ...
                  <li className="flex items-start gap-2">
                    <div className="w-1 h-1 rounded-full bg-blue-500 mt-1.5 shrink-0" />
                    <span>
                      <strong>CI/CD Pipelines:</strong> Automated GitHub Actions for Docker builds and Firebase deployment.
                    </span>
                  </li>
                </ul>
              </div>

              {/* Column B: Systems Engineering (UPDATED) */}
              <div className="space-y-3">
                <h4 className="text-sm font-semibold text-slate-900 dark:text-white border-b border-slate-100 dark:border-slate-700 pb-2 mb-2">
                  Key Features
                </h4>
                <ul className="space-y-2 text-xs text-muted-foreground">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Native Hardware:</strong> Frictionless NFC "tap-to-collect" protocols with automated QR code fallback for universal device compatibility.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1 h-1 rounded-full bg-green-500 mt-1.5 shrink-0" />
                    <span>
                      <strong>Secure Redemption:</strong> Transactional validation logic ensuring accurate stamp accrual and real-time fraud prevention.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1 h-1 rounded-full bg-green-500 mt-1.5 shrink-0" />
                    <span>
                      <strong>Real-Time Sync:</strong> Firestore listeners for instantaneous cross-platform updates without WebSockets.
                    </span>
                  </li>
                </ul>
              </div>
