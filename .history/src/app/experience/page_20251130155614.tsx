      ...
      <section className="bg-gray-900 text-white pt-32 pb-20">
        <div className="container mx-auto px-6">
          ...
          <p className="text-xl max-w-3xl">
            ...
            [cite_start]Adept in web, mobile, and AI development pipelines[cite: 3, 6].
          </p>
        </div>
      </section>
              ...
              <div className="relative border-l-4 border-blue-600 pl-8 pb-6">
                ...
                <div className="mb-12">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p className="text-gray-700 mb-4">
                      [cite_start]Designed and delivered a dual-purpose cloud platform for the hospitality sector, integrating a B2C digital loyalty app with a B2B Community Hub[cite: 7, 8].
                    </p>
                    <ul className="list-disc pl-5 space-y-1 text-gray-600 mb-4">
                      [cite_start]<li>Engineered a high-availability hybrid architecture using Next.js on Google Cloud Run and Flutter for native mobile clients[cite: 10, 11].</li>
                      [cite_start]<li>Built a serverless backend with Firebase, utilizing Firestore NoSQL data modeling and Atomic Transactions[cite: 13].</li>
                      [cite_start]<li>Implemented real-time data synchronization using Firestore Listeners and fan-out writes for notifications[cite: 15].</li>
                      [cite_start]<li>Established automated CI/CD pipelines using GitHub Actions for deployment to Cloud Run and GCP[cite: 19].</li>
                    </ul>
                ...
                <div className="mb-12">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p className="text-gray-700 mb-4">
                      [cite_start]Full-stack development in an IT leadership role, acting as principal engineer for internal manufacturing and operational projects[cite: 23].
                    </p>
                    <ul className="list-disc pl-5 space-y-1 text-gray-600 mb-4">
                      [cite_start]<li>Developed production line monitoring tools (ASP.NET MVC) to visualize real-time throughput and identify bottlenecks[cite: 25].</li>
                      [cite_start]<li>Created an intranet portal integrated with Azure AD for single sign-on[cite: 26].</li>
                      [cite_start]<li>Wrote complex SQL stored procedures to integrate factory floor systems with the central ERP[cite: 27].</li>
                      [cite_start]<li>Introduced React and Next.js to modernize QA dashboards and improve user experience[cite: 30].</li>
                    </ul>
                    <div className="flex flex-wrap gap-2">
                ...
                <div className="mb-12">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p className="text-gray-700 mb-4">
                      [cite_start]Developed custom features and extensions for Sage CRM, translating complex client requirements into technical designs[cite: 37, 44].
                    </p>
                    <ul className="list-disc pl-5 space-y-1 text-gray-600 mb-4">
                      [cite_start]<li>Built an inspection portal (jQuery/Bootstrap) allowing field engineers to input offline data and sync upon reconnection[cite: 39].</li>
                      [cite_start]<li>Automated data import/export by integrating Excel processing into CRM workflows using C# and VSTO[cite: 40].</li>
                      [cite_start]<li>Enhanced CRM reports and dashboards with custom SQL queries and ASP pages[cite: 42].</li>
                    </ul>
                    <div className="flex flex-wrap gap-2">
                ...
                <div className="mb-12">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p className="text-gray-700 mb-4">
                      [cite_start]Developed pixel-perfect web solutions for major enterprise clients like Dove, Nescafé, and EasyJet[cite: 45, 47].
                    </p>
                    <ul className="list-disc pl-5 space-y-1 text-gray-600 mb-4">
                      [cite_start]<li>Built back-end systems for promotional campaigns using ASP.NET and MS SQL[cite: 48, 49].</li>
                      [cite_start]<li>Implemented dynamic content for high-volume email campaigns reaching millions of customers[cite: 51].</li>
                      [cite_start]<li>Migrated legacy PHP/MySQL websites to ASP.NET platforms, improving security and stability[cite: 52].</li>
                      [cite_start]<li>Optimized performance to achieve sub-second load times despite heavy graphical content[cite: 55].</li>
                    </ul>
                    <div className="flex flex-wrap gap-2">
                ...
                <div>
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p className="text-gray-700 mb-4">
                      [cite_start]Full-stack developer for interactive fantasy sports gaming platforms handling tens of thousands of concurrent users[cite: 56, 60].
                    </p>
                    <ul className="list-disc pl-5 space-y-1 text-gray-600 mb-4">
                      [cite_start]<li>Programmed complex game logic and real-time leaderboards using C# and T-SQL[cite: 59].</li>
                      [cite_start]<li>Built and published a companion iOS app in Objective-C[cite: 61, 62].</li>
                      [cite_start]<li>Implemented OAuth login flows (Facebook/Yahoo) to lower barriers to entry[cite: 64].</li>
                      [cite_start]<li>Developed internal admin tools for game operations and content moderation[cite: 67].</li>
                    </ul>
                    <div className="flex flex-wrap gap-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    [cite_start]Successfully delivered the fully functional CAFE:CONNECT platform into production, leveraging modern serverless architecture and cross-platform mobile development[cite: 21].
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    Optimized inventory sync processes at Higgidy, cutting run time by 50%. [cite_start]Achieved sub-second load times for heavy graphical campaign sites at Havas Helia[cite: 33, 55].
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    [cite_start]Published native applications for various projects, ranging from Fantasy Sports (iOS/Objective-C) to hospitality rewards (Flutter/Dart)[cite: 17, 62].
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    [cite_start]Developed scheduled jobs and automated reporting tools that saved hours of manual work weekly for manufacturing and administrative teams[cite: 28].
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md flex items-start">
                  ...
                  <div>
                    ...
                    [cite_start]<p className="text-gray-500 text-sm mt-1">Recognized for comprehensive knowledge in privacy laws and data protection[cite: 84].</p>
                  </div>
                </div>
