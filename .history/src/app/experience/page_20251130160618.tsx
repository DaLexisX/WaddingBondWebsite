      ...
      <section className="bg-gray-900 text-white pt-32 pb-20">
        <div className="container mx-auto px-6">
          ...
          <p className="text-xl max-w-3xl">
            ...
            Adept in web, mobile, and AI development pipelines<sup>3,6</sup>.
          </p>
        </div>
      </section>
              ...
              <div className="relative border-l-4 border-blue-600 pl-8 pb-6">
                ...
                <div className="mb-12">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p className="text-gray-700 mb-4">
                      Designed and delivered a dual-purpose cloud platform for the hospitality sector, integrating a B2C digital loyalty app with a B2B Community Hub<sup>7,8</sup>.
                    </p>
                    <ul className="list-disc pl-5 space-y-1 text-gray-600 mb-4">
                      <li>Engineered a high-availability hybrid architecture using Next.js on Google Cloud Run and Flutter for native mobile clients<sup>10,11</sup>.</li>
                      <li>Built a serverless backend with Firebase, utilizing Firestore NoSQL data modeling and Atomic Transactions<sup>13</sup>.</li>
                      <li>Implemented real-time data synchronization using Firestore Listeners and fan-out writes for notifications<sup>15</sup>.</li>
                      <li>Established automated CI/CD pipelines using GitHub Actions for deployment to Cloud Run and GCP<sup>19</sup>.</li>
                    </ul>
                ...
                <div className="mb-12">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p className="text-gray-700 mb-4">
                      Full-stack development in an IT leadership role, acting as principal engineer for internal manufacturing and operational projects<sup>23</sup>.
                    </p>
                    <ul className="list-disc pl-5 space-y-1 text-gray-600 mb-4">
                      <li>Developed production line monitoring tools (ASP.NET MVC) to visualize real-time throughput and identify bottlenecks<sup>25</sup>.</li>
                      <li>Created an intranet portal integrated with Azure AD for single sign-on<sup>26</sup>.</li>
                      <li>Wrote complex SQL stored procedures to integrate factory floor systems with the central ERP<sup>27</sup>.</li>
                      <li>Introduced React and Next.js to modernize QA dashboards and improve user experience<sup>30</sup>.</li>
                    </ul>
                    <div className="flex flex-wrap gap-2">
                ...
                <div className="mb-12">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p className="text-gray-700 mb-4">
                      Developed custom features and extensions for Sage CRM, translating complex client requirements into technical designs<sup>37,44</sup>.
                    </p>
                    <ul className="list-disc pl-5 space-y-1 text-gray-600 mb-4">
                      <li>Built an inspection portal (jQuery/Bootstrap) allowing field engineers to input offline data and sync upon reconnection<sup>39</sup>.</li>
                      <li>Automated data import/export by integrating Excel processing into CRM workflows using C# and VSTO<sup>40</sup>.</li>
                      <li>Enhanced CRM reports and dashboards with custom SQL queries and ASP pages<sup>42</sup>.</li>
                    </ul>
                    <div className="flex flex-wrap gap-2">
                ...
                <div className="mb-12">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p className="text-gray-700 mb-4">
                      Developed pixel-perfect web solutions for major enterprise clients like Dove, Nescafé, and EasyJet<sup>45,47</sup>.
                    </p>
                    <ul className="list-disc pl-5 space-y-1 text-gray-600 mb-4">
                      <li>Built back-end systems for promotional campaigns using ASP.NET and MS SQL<sup>48,49</sup>.</li>
                      <li>Implemented dynamic content for high-volume email campaigns reaching millions of customers<sup>51</sup>.</li>
                      <li>Migrated legacy PHP/MySQL websites to ASP.NET platforms, improving security and stability<sup>52</sup>.</li>
                      <li>Optimized performance to achieve sub-second load times despite heavy graphical content<sup>55</sup>.</li>
                    </ul>
                    <div className="flex flex-wrap gap-2">
                ...
                <div>
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p className="text-gray-700 mb-4">
                      Full-stack developer for interactive fantasy sports gaming platforms handling tens of thousands of concurrent users<sup>56,60</sup>.
                    </p>
                    <ul className="list-disc pl-5 space-y-1 text-gray-600 mb-4">
                      <li>Programmed complex game logic and real-time leaderboards using C# and T-SQL<sup>59</sup>.</li>
                      <li>Built and published a companion iOS app in Objective-C<sup>61,62</sup>.</li>
                      <li>Implemented OAuth login flows (Facebook/Yahoo) to lower barriers to entry<sup>64</sup>.</li>
                      <li>Developed internal admin tools for game operations and content moderation<sup>67</sup>.</li>
                    </ul>
                    <div className="flex flex-wrap gap-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    Successfully delivered the fully functional CAFE:CONNECT platform into production, leveraging modern serverless architecture and cross-platform mobile development<sup>21</sup>.
                  </p>
                </div>
